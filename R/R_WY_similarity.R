...
wy_comparison<-data.frame(WaterYear=c(2005:2021),SimilarWY=NA)

similarwy<-vector()
similarwy[1]<-data.frame(sort(wy_dist[,"2005"])) %>% top_n(-1) %>% row.names()
similarwy[2]<-data.frame(sort(wy_dist[,"2006"])) %>% top_n(-1) %>% row.names()
similarwy[3]<-data.frame(sort(wy_dist[,"2007"])) %>% top_n(-1) %>% row.names()
similarwy[4]<-data.frame(sort(wy_dist[,"2008"])) %>% top_n(-1) %>% row.names()
similarwy[5]<-data.frame(sort(wy_dist[,"2009"])) %>% top_n(-1) %>% row.names()
similarwy[6]<-data.frame(sort(wy_dist[,"2010"])) %>% top_n(-1) %>% row.names()
similarwy[7]<-data.frame(sort(wy_dist[,"2011"])) %>% top_n(-1) %>% row.names()
similarwy[8]<-data.frame(sort(wy_dist[,"2012"])) %>% top_n(-1) %>% row.names()
similarwy[9]<-data.frame(sort(wy_dist[,"2013"])) %>% top_n(-1) %>% row.names()
similarwy[10]<-data.frame(sort(wy_dist[,"2014"])) %>% top_n(-1) %>% row.names()
similarwy[11]<-data.frame(sort(wy_dist[,"2015"])) %>% top_n(-1) %>% row.names()
similarwy[12]<-data.frame(sort(wy_dist[,"2016"])) %>% top_n(-1) %>% row.names()
similarwy[13]<-data.frame(sort(wy_dist[,"2017"])) %>% top_n(-1) %>% row.names()
similarwy[14]<-data.frame(sort(wy_dist[,"2018"])) %>% top_n(-1) %>% row.names()
similarwy[15]<-data.frame(sort(wy_dist[,"2019"])) %>% top_n(-1) %>% row.names()
similarwy[16]<-data.frame(sort(wy_dist[,"2020"])) %>% top_n(-1) %>% row.names()
similarwy[17]<-data.frame(sort(wy_dist[,"2021"])) %>% top_n(-1) %>% row.names()
