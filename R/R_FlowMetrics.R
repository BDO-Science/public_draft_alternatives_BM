...
#Plot for OUTFLOW
plot_outflow <- ggplot2::ggplot(data=data_dayflow_added,aes(x=dummyDate,y=OUT,group=WY,color=Sac_WY))+
  ggplot2::theme_bw()+
  ggplot2::geom_line(alpha=0.5)+
  facet_grid(TimePeriod~Sac_WY)+
  geom_smooth(aes(group=Sac_WY),se=F)+
...
#Print figure
tiff(filename=file.path(output_root,"Figure_Outflow_by_TimePeriod.tiff"),
     type="cairo",
     units="in", 
     width=14, #10*1, 
     height=8, #22*1, 
...
#Plot for EXPORT COMBINED
plot_export <- ggplot2::ggplot(data=data_dayflow_added,aes(x=dummyDate,y=EXPORT,group=WY,color=Sac_WY))+
  ggplot2::theme_bw()+
  ggplot2::geom_line(alpha=0.5)+
  facet_grid(TimePeriod~Sac_WY)+
  geom_smooth(aes(group=Sac_WY),se=F)+
  ...
  ggplot2::theme(plot.title=element_text(size=9), 
                 ...
                 legend.position = "none",
                 strip.background = element_rect(size=0.3)) + 
  ggplot2::ylab(bquote("Delta"~export~"("*ft^3*"/s)"))+ggplot2::xlab(NULL)+
  ggplot2::scale_x_date(date_labels = "%b",date_breaks  ="1 month")

plot_export

#Print figure
tiff(filename=file.path(output_root,"Figure_Export_by_TimePeriod.tiff"),
     type="cairo",
     units="in", 
     width=14, #10*1, 
     height=8, #22*1, 
...
#Plot for Sacramento River
plot_sac <- ggplot2::ggplot(data=data_dayflow_added,aes(x=dummyDate,y=SAC,group=WY,color=Sac_WY))+
  ggplot2::theme_bw()+
  ggplot2::geom_line(alpha=0.5)+
  facet_grid(TimePeriod~Sac_WY)+
  geom_smooth(aes(group=Sac_WY),se=F)+
  ...
  ggplot2::theme(plot.title=element_text(size=9), 
                 ...
                 legend.position = "none",
                 strip.background = element_rect(size=0.3)) + 
  ggplot2::ylab(bquote("Sacramento River flow at"~Freeport~"("*ft^3*"/s)"))+ggplot2::xlab(NULL)+
  ggplot2::scale_x_date(date_labels = "%b",date_breaks  ="1 month")

plot_sac

#Plot for San Joaquin River
plot_sjr <- ggplot2::ggplot(data=data_dayflow_added,aes(x=dummyDate,y=SJR,group=WY,color=Sac_WY))+
  ggplot2::theme_bw()+
  ggplot2::geom_line(alpha=0.5)+
  facet_grid(TimePeriod~Sac_WY)+
  geom_smooth(aes(group=Sac_WY),se=F)+
  ...
  ggplot2::theme(plot.title=element_text(size=9), 
                 ...
                 legend.position = "none",
                 strip.background = element_rect(size=0.3)) + 
  ggplot2::ylab(bquote("San Joaquin River flow at"~Vernalis~"("*ft^3*"/s)"))+ggplot2::xlab(NULL)+
  ggplot2::scale_x_date(date_labels = "%b",date_breaks  ="1 month")

plot_sjr

#Print figure
tiff(filename=file.path(output_root,"Figure_SAC_by_TimePeriod.tiff"),
     type="cairo",
     units="in", 
     width=14, #10*1, 
     height=8, #22*1, 
...
#Print figure
tiff(filename=file.path(output_root,"Figure_SJR_by_TimePeriod.tiff"),
     type="cairo",
     units="in", 
     width=14, #10*1, 
     height=8, #22*1, 
...
#Plot for X2
plot_X2 <- ggplot2::ggplot(data=data_dayflow_added,aes(x=dummyDate,y=X2,group=WY,color=Sac_WY))+
  ggplot2::theme_bw()+
  ggplot2::geom_line(alpha=0.5)+
  facet_grid(TimePeriod~Sac_WY)+
  geom_smooth(aes(group=Sac_WY),se=F)+
  ...
  ggplot2::theme(plot.title=element_text(size=9), 
                 ...
                 legend.position = "none",
                 strip.background = element_rect(size=0.3)) + 
  ggplot2::ylab("X2 (km)")+ggplot2::xlab(NULL)+
  ggplot2::scale_x_date(date_labels = "%b",date_breaks  ="1 month")

plot_X2

#Print figure
tiff(filename=file.path(output_root,"Figure_X2_by_TimePeriod.tiff"),
     type="cairo",
     units="in", 
     width=14, #10*1, 
     height=8, #22*1, 
